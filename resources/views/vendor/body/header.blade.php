        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    ...
                    <img src="{{(empty(Auth::user()->photo)? url('/backend/upload/vendor/avatar.png') :  url('/backend/upload/vendor/images/'.Auth::user()->photo))}}" class="user-img"
                        alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{ Auth::user()->name }}</p>            {{-- Auth charao kaj hoy jemon {{ $adminInfo->name }} --}}
